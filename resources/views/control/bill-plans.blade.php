        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    Bill plan records
                    <a href="{{ route('create-bill') }}" class="btn btn-primary">Create New Plan</a>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="btn-group mb-1">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonIcon">
                                                    <a class="dropdown-item" href="/pricing/bill/{{ $Price->id }}"
                                                        href=""> View</a>
                                                    <a class="dropdown-item" href="/bill/delete/{{ $Price->id }}" confirm="Are you sure to delete this record ?">
                                                        Delete</a>
                                                </div>
                                            </div>
                                        </div>
