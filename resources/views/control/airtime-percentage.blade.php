        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Airtime Percentage</h3>
                    <p class="text-subtitle text-muted">View and manage airtime percentage on the system</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Airtime perc</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    Airtime percentage records
                    <a href="{{ route('create-airtime') }}" class="btn btn-primary">Create New Plan</a>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="btn-group mb-1">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonIcon">
                                                    <a class="dropdown-item" href="/pricing/airtime/{{ $Price->id }}"
                                                        href=""> View</a>
                                                    <a class="dropdown-item" href="/airtime/delete/{{ $Price->id }}" confirm="Are you sure to delete this record ?">
                                                        Delete</a>
                                                </div>
                                            </div>
                                        </div>
