                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <h4>{{ number_format($History->product_price, 2)}}</h4>
                                            </div><hr>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="country-floating">Rate</label>
                                                <h4>{{ $History->product_rate }}</h4>
                                            </div> <hr>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="country-floating">Quantity</label>
