        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Create and manage product record</p>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12 mt-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="dripfeed" name="dripfeed" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-12 mt-4 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="refill" name="refill" class="form-control">
                                            </div>
                                        </div>
