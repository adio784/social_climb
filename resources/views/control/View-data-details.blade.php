                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <h4>{{ strtoupper($History->network_id) }}</h4>
                                            </div>
                                            <hr>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="last-name-column">Plan</label>
                                                <h4>{{ $History->plan_size . ' ' . $History->plan_measure }}</h4>
                                            </div>
                                            <hr>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <h4>{{ $History->mobile_number }}</h4>
                                            </div><hr>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="city-column">Price</label>
                                                <h4>{{ $History->plan_amount }}</h4>
                                            </div><hr>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
