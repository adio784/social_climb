                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ 'Bill plan' }}</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('edit_bill') }}" method="POST">
                                    @csrf
                                    <div id="error_result">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="disco">
                                                    @foreach ($Discos as $Disco)
                                                        <option @if ($Disco->id == $Plan->disco_id) selected @endif
                                                            value="{{ $Disco->id }}">{{ $Disco->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
